...
public class StandardRegimenTagHandlerSupport1_6 /*implements StandardRegimenTagHandlerSupport*/ {
	 ...
	 * Concept.class)); attributeDescriptors.add(new
	 * AttributeDescriptor("regimenCodes", RegimenSuggestion.class)); return
	 * Collections.unmodifiableList(attributeDescriptors); }
	 * 
	 ...
	 * 
	 * StandardRegimenElement element = new
	 * StandardRegimenElement(session.getContext(), parameters);
